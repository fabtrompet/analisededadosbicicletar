$(document).ready(function(){
      ...
      function get_dados2(id_estacao,dia_semana){
        return $.ajax({
          ...
          method: "POST",
          data: {tipo: "mediatempo", id_estacao: id_estacao, dia_semana: dia_semana},
          dataType: 'json',
      ...
      function reload2(id_estacao,nome_estacao,dia_semana,maior){ 
        ...
        title:{
          text: "Intervalo Médio em Horas de Bicicletas Disponiveis ("+dias_semana[dia_semana]+")"
        },
        axisY:{
          title: "Horas",
          interval: 2 
...
chart.render();
      ...
      function get_dados(id_estacao){
        return $.ajax({
          url: "http://localhost/site-tcc/dados.php",
          method: "POST",
          data: {tipo: "porcentagem_dia_semana", id_estacao: id_estacao},
          dataType: 'json',
          success: function(data) {
            console.log(data);
            quantidade = [];
