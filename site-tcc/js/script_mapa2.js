$(document).ready(function(){
      ...
      function get_dados2(id_estacao,dia_semana){
        return $.ajax({
          ...
          method: "POST",
          data: {tipo: "horario_semana", id_estacao: id_estacao, dia_semana: dia_semana},
          dataType: 'json',
      ...
      function reload2(id_estacao,nome_estacao,dia_semana,maior){ 
        $.when(get_dados2(id_estacao,dia_semana)).done(function(){
          ...
          $("#myChart2").remove();
          chartdata2 = [];
          $('#result2').html('<canvas id="myChart2" height="80px"></canvas>');
          chartdata2 = {
            labels: horario2,
            datasets : [
            {
              label: "Estação "+nome_estacao+" - "+dias_semana[dia_semana],
      ...
      function get_dados(id_estacao){
        return $.ajax({
          url: "http://localhost/site-tcc/dados.php",
          method: "POST",
          data: {tipo: "dia_semana", id_estacao: id_estacao},
          dataType: 'json',
          success: function(data) {
            console.log(data);
            quantidade = [];
      ...
      function reload(id_estacao,nome_estacao){ 
        $.when(get_dados(id_estacao)).done(function(){
         ...
         var maior = [];
         function get_total(id_estacao){
        return $.ajax({
          url: "http://localhost/site-tcc/dados.php",
          method: "POST",
          data: {tipo: "total_semana", id_estacao: id_estacao},
          dataType: 'json',
          success: function(data) {
            console.log(data);
          ...
          $.when(get_total(id_estacao)).done(function(){
          reload2(id_estacao,nome_estacao,0,maior);
        });
         $('#myChart').click(
            function(evt){
            ...
            if (firstPoint !== undefined)
                reload2(id_estacao,nome_estacao,dias_semana.indexOf(label),maior);
            });
