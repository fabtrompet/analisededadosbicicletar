$(document).ready(function(){
      ...
      function get_dados(id_estacao,hora,dia_semana){
        return $.ajax({
          url: "http://localhost/site-tcc/dados.php",
          method: "POST",
          data: {tipo: "porcentagem_horano", id_estacao: id_estacao, hora:hora, dia_semana: dia_semana},
          dataType: 'json',
          success: function(data) {
            console.log(data);
            media = "";
      ...
      $("#origem").click(function(){
        ...
        $.when(get_dados($("#id_estacao").val(),$("#hora").val(),$("#dia_semana").val())).done(function(){
        var chart = new CanvasJS.Chart("chartdiv", {
  animationEnabled: true,
  title:{
    text: "Probabilidade de Não Ter Bicicleta"
  },
  axisY:{
    title: "Porcentagem"
  },
  ...
  },
  {
    ...
    toolTipContent: "<b>{name}:</b> {y[0]} - "+margemmenos+" %",
    dataPoints: [
